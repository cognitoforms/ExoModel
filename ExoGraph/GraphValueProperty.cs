...
namespace ExoGraph
{
	...
	public abstract class GraphValueProperty : GraphProperty
	{
		...
		protected internal GraphValueProperty(GraphType declaringType, string name, string label, string format, bool isStatic, Type propertyType, TypeConverter converter, bool isList, bool isReadOnly, bool isPersisted, Attribute[] attributes)
