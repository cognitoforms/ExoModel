using System;
using System.Linq;
using ExoModel.UnitTests.Models.Shopping;
using Microsoft.VisualStudio.TestTools.UnitTesting;
using System.Linq.Expressions;
using ExoModel.UnitTests.Models;
using ExoModel.UnitTests.Models.Movies;
...
namespace ExoModel.UnitTests
{
	...
	public partial class ModelExpressionTests : TestModelBase
	{
		/// <summary>
		...
		public void Expression_GetPath()
		{
			// Simple path
			TestPath((Request r) =>
		...
		[TestMethod]
		public void Expression_PropertyPaths()
		{
			// Get the 2010 "Robin Hood" movie
			var movie = Context.Fetch<Movie>(1);

			TestExpression(movie, "Director.Person.FirstName", "Ridley", "Director.Person.FirstName");
		}
	}
}
